...
def run_scenario_2(start='2019-01-01', end='2019-02-01'):
    '''
    Scenario 2: An expanded energy system at Easter Bush Campus: The same heat pump
...
if __name__ == "__main__":
    # network, results = run_scenario_2(start='2019-01-01', end='2019-02-01')
    run_scenario_2(start='2019-01-01', end='2020-01-01')